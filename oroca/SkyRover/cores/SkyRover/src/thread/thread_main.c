...
//-- 내부 함수
//
void thread_loop(void const *argument);
...
void thread_main(void)
{
    ...
    osThreadDef(TASK4, thread_loop, osPriorityNormal, 0, configMINIMAL_STACK_SIZE);
    ...
    Thread_Handle_loop = osThreadCreate(osThread(TASK4), NULL);
